      ...
      <div class="transfer-sub-warpper">
        ...
        <div v-show="showSecondStep">
          ...
          <van-cell-group>
            ...
            <van-field v-model="form.password" ref="visualPassword" type="text" @click-right-icon="displayPassword = false" :placeholder="$t('transaction.walletPwdPlaceholder')" right-icon="eye-o" v-show="displayPassword"/>
          </van-cell-group>
          <pl-stick :offset-bottom="0">
