<template>
  <div  class="full-page guide-main">
    ...
    <div class="guide-container">
      ...
      <br>
      <br>
      <van-button size="large" round @click="toRecoveryWallet" class="border-color text-primary" :loading="loading" v-text="$t('wallet.recoverWallet')"></van-button>
    </div>
    <div class="text-center text-tip-color guide-protocol-text">
      {{ $t("wallet.guideText") }}&nbsp;<span @click="showUserProtocol" class="text-primary">{{$t("wallet.guideProto")}}</span>
    </div>
