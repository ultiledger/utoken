        ...
        <div class="content-wrapper">
          ...
          <div class="bottom">
            <pl-wallet-addr
              class="small-font"
              :complete="false"
              :address="data.address"></pl-wallet-addr>
            <span class="pull-right"><i class="ultfont ult-ellipsis"></i></span>
          </div>
        </div>
      </div>
    </div>
    <pl-content-block :offsetTop="214" :offsetBottom="51" heightType="minHeight" style="overflow-y: hidden;">
    <div class="text-center" v-if="loading"><van-loading style="margin: 10px auto;"/></div>
    <div v-else>
      <account-activated v-if="!activated"
                         :acct-type="data.type"
                         :short-acct-type="shortType(data.type)"
                         @transitionActivated="showQRcode(data.type)"></account-activated>
      <div v-else>
        <div class="asset-bar" v-if="this.balances && this.balances.length > 0">
          <div class="big-font" style="font-weight: bold">
            ...
            <span style="vertical-align: middle;">
              &nbsp;
              <van-icon  v-if="!$store.state.setting.privacyMode"  name="password-view" @click="setMode(true)"/>
